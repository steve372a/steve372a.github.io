...
read -r -p "请选择一个项目:" input
    case $input in
        ...
        4)osascript -e 'tell app "System Events" to display dialog "本程序版本为：0.2.4，编译日期为 2023 年 8 月 12 日。" buttons {"好的"}' >/dev/null 2>&1
        $0;;
        ...
        7)open -a "/Applications/Safari.app" https://steve372yeyeye.github.io/update/qcomplie;;
    esac